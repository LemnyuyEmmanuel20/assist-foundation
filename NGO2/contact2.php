                    ...
                    <div class="row clearfix">
                        ...
                        <div class="info-box col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box wow fadeInUp" data-wow-delay="0ms">
                                ...
                                <h4>Our Location</h4>
                                <ul>
                                    <li>any random location in australia</li>
                                </ul>
                            </div>
                        </div>
                        <!--Info Box-->
                        <div class="info-box col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box wow fadeInUp" data-wow-delay="300ms">
                                ...
                                <div class="icon-box"><i class="fas fa-phone"></i>
                                </div>
                                <h4>Phone Number</h4>
                                <ul>
                                    <li>
                                            <a href="tel:+61(049)314-8367">&nbsp;&nbsp;+61(049)314-8367</a></li>
                                </ul>
                            </div>
                        </div>
                        <!--Info Box-->
                        <div class="info-box col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box wow fadeInUp" data-wow-delay="600ms">
                                ...
                                <h4>Email Address</h4>
                                <ul>
                                    <li><a href="mailto:Buildwithus@theassistfoundation.info">Buildwithus@theassistfoundation.info</a></li>
